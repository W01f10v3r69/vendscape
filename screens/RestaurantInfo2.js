...
import RestaurantList2 from "../components/Restaurant/RestaurantList2"

const IMAGE_WIDTH = 290;

const RestaurantInfo2 = ({ navigation, route }) => {
  const { Banner_Image, name, _id, email, phone } = route.params;
  ...
  return (
    <View style={tw`flex relative bg-white`}>
      ...
      >
        <View
          style={tw.style("flex flex-col w-full justify-between h-full pt-5", {
            zIndex: 100,
            elevation: 100,
          })}
        >
          ...
          >
            ...
            <BoltSemiBoldText
              style={tw.style("my-auto text-black my-auto mx-auto", {
                fontSize:
                  Platform.OS === "ios"
                    ? 20
      ...
      <View style={tw.style("flex bg-white h-full")}>
        ...
        >
          ...
          >
            <View style={tw`w-full flex flex-row justify-between items-start`}>
              <BoltSemiBoldText
            ...
            <View style={tw`w-full mt-5 flex flex-col`}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.6}
              >
                <BoltSemiBoldText style={tw`text-black mx-auto`}>
                  Call Vendor
                </BoltSemiBoldText>
              </TouchableOpacity>
            </View>
          ...
          <View style={tw`pb-5`}>
            <RestaurantList2 navigation={navigation} _id={_id} />
          </View>
        </Animated.ScrollView>
      </View>
    </View>
