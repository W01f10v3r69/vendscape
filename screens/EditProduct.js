...
function EditProduct({ navigation, route, nameInp, descriptionInp, priceInp, veganInp, cat, bannerInp, foodId }) {
    const [id, setId] = useState("");
    const [show, setShow] = useState(false);
    const [name, setName] = useState(nameInp);
    const [price, setPrice] = useState(priceInp);
    const [des, setDes] = useState(descriptionInp);
    ...
    const [veganValue, setVeganValue] = useState(veganInp);
    ...
    const uploadProduct = () => {
        ...
        const url = `https://floating-wildwood-95983.herokuapp.com/food/editFood/${foodId}`;
        axios
            .post(url, formdata, {
                hedaers: {
        ...
        return navigate == 0 ? (
            <>
                <ScrollView style={styles.container}>
                    ...
                    <Text style={styles.pageTitle}>Edit Products</Text>
